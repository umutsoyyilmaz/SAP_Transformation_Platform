...
SAP_ACTIVATE_RACI_ACTIVITIES: list[dict] = [
    # discover phase
    {"name": "Proje Başlatma Onayı", "phase": "discover", "category": "governance", "order": 1},
    {"name": "Proje Hedefleri Belirleme", "phase": "discover", "category": "governance", "order": 2},
    {"name": "Organizasyon ve Paydaş Analizi", "phase": "discover", "category": "governance", "order": 3},
    {"name": "Mevcut Sistem Envanter Tespiti", "phase": "discover", "category": "technical", "order": 4},
    {"name": "Kapsam Ön Değerlendirme", "phase": "discover", "category": "technical", "order": 5},
    # prepare phase
    {"name": "Proje Charter Dokümantasyonu", "phase": "prepare", "category": "governance", "order": 10},
    {"name": "Steering Committee Kurulumu", "phase": "prepare", "category": "governance", "order": 11},
    {"name": "Proje Yönetim Planı Hazırlama", "phase": "prepare", "category": "governance", "order": 12},
    {"name": "Altyapı ve Sistem Hazırlığı", "phase": "prepare", "category": "technical", "order": 13},
    {"name": "Proje Ekibi Oluşturma ve Eğitim Planı", "phase": "prepare", "category": "training", "order": 14},
    {"name": "Risk ve Sorun Takip Kurulumu", "phase": "prepare", "category": "governance", "order": 15},
    # explore phase
    {"name": "Süreç Atölyelerinin Yönetimi", "phase": "explore", "category": "technical", "order": 20},
    {"name": "Fit-Gap Analizi ve Raporlama", "phase": "explore", "category": "technical", "order": 21},
    {"name": "WRICEF Listesi Oluşturma", "phase": "explore", "category": "technical", "order": 22},
    {"name": "Veri Göç Stratejisi Belirleme", "phase": "explore", "category": "data", "order": 23},
    {"name": "Kullanıcı Hikâyeleri ve Gereksinim Dokümanı", "phase": "explore", "category": "technical", "order": 24},
    {"name": "Entegrasyon Mimarisi Tasarımı", "phase": "explore", "category": "technical", "order": 25},
    # realize phase
    {"name": "Konfigürasyon ve Geliştirme Yönetimi", "phase": "realize", "category": "technical", "order": 30},
    {"name": "WRICEF Geliştirme Onayı", "phase": "realize", "category": "technical", "order": 31},
    {"name": "Veri Göç Geliştirme ve Test", "phase": "realize", "category": "data", "order": 32},
    {"name": "Entegrasyon Testleri (SIT)", "phase": "realize", "category": "testing", "order": 33},
    {"name": "Performans ve Yük Testleri", "phase": "realize", "category": "testing", "order": 34},
    {"name": "Eğitim Materyali Hazırlama", "phase": "realize", "category": "training", "order": 35},
    {"name": "Güvenlik ve Yetkilendirme Konsepti", "phase": "realize", "category": "technical", "order": 36},
    # deploy phase
    {"name": "Kullanıcı Kabul Testi (UAT) Koordinasyonu", "phase": "deploy", "category": "testing", "order": 40},
    {"name": "Son Kullanıcı Eğitimleri", "phase": "deploy", "category": "training", "order": 41},
    {"name": "Kesim Planı (Cutover Plan) Hazırlama", "phase": "deploy", "category": "cutover", "order": 42},
    {"name": "Veri Göç Geçişi (Prod)", "phase": "deploy", "category": "data", "order": 43},
    {"name": "Canlandırma (Go-Live) Kararı", "phase": "deploy", "category": "governance", "order": 44},
    {"name": "Hypercare Destek Planı", "phase": "deploy", "category": "governance", "order": 45},
    # run phase
    {"name": "Hypercare Destek İzleme", "phase": "run", "category": "governance", "order": 50},
    {"name": "Performans KPI İzleme", "phase": "run", "category": "technical", "order": 51},
    {"name": "Hata ve Sorun Yönetimi", "phase": "run", "category": "technical", "order": 52},
    {"name": "Proje Kapanış Değerlendirmesi", "phase": "run", "category": "governance", "order": 53},
]
