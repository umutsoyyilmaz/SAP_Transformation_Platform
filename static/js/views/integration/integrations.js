...
const IntegrationsView = (function () {
  ...
  function render() {
    ...
    container.innerHTML = `
      ...
      <div class="modal-overlay integrations-modal-overlay" id="webhook-modal">
        <div class="modal integrations-modal--webhook">
      ...
      <!-- Jira Connect Modal -->
      <div class="modal-overlay integrations-modal-overlay" id="jira-modal">
        <div class="modal integrations-modal--jira">
          <div class="modal-header">
            <h3>Connect Jira</h3>
      ...
      <div class="modal-overlay integrations-modal-overlay" id="import-modal">
        <div class="modal integrations-modal--import">
          <div class="modal-header">
  ...
  function renderCloudAlmTab(c) {
    ...
    c.innerHTML = `
      <div class="integrations-tab-panel">
        ...
        <div class="integrations-tab-panel__section">
          <h4 class="integrations-tab-panel__title">Sync Log (last 50 records)</h4>
          <div class="integrations-status-banner ${isActive ? 'integrations-status-banner--active' : 'integrations-status-banner--inactive'}">
          ...
          <table class="data-table integrations-log-table">
  ...
  function _renderComingSoonCard({ icon, title, subtitle, eta, description, badges = [] }) {
    const pillsHtml = badges.map(b =>
      `<span class="integrations-coming-card__badge">${b}</span>`
    ).join('');
    return `
      <div class="integrations-coming-card">
        <div class="integrations-coming-card__header">
          <div class="integrations-coming-card__icon">
            <i class="${icon}"></i>
          </div>
          <div>
            <div class="integrations-coming-card__title">${title}</div>
            <div class="integrations-coming-card__subtitle">${subtitle}</div>
          </div>
          <span class="integrations-coming-card__eta">
            🔵 Coming ${eta}
          </span>
        </div>
        <p class="integrations-coming-card__copy">${description}</p>
        <div class="integrations-coming-card__badges">${pillsHtml}</div>
        <button
          class="btn btn-outline btn-sm integrations-coming-card__action"
