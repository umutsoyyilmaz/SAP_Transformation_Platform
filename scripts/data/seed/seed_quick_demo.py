...
Usage:
    python scripts/data/seed/seed_quick_demo.py              # Full OTC+PTP demo
    python scripts/data/seed/seed_quick_demo.py --scenario otc   # Only OTC
    python scripts/data/seed/seed_quick_demo.py --scenario ptp   # Only PTP
