...
Usage:
    ...
    python scripts/data/seed/seed_demo_data.py --append
...
from app.models.interface_factory import Interface, Wave as IntWave, ConnectivityTest, SwitchPlan, InterfaceChecklist
    ...
    with app.app_context():
        ...
        for s_d in SUITE_DATA:
            ...
            suite = TestSuite(
                ...
                purpose=s_d.get("purpose") or s_d.get("suite_type", "Custom"),
