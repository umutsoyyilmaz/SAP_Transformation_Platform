...
Usage:
    python scripts/data/migrate/migrate_tenants.py                  # Migrate all tenants
    python scripts/data/migrate/migrate_tenants.py --tenant acme    # Migrate single tenant
    python scripts/data/migrate/migrate_tenants.py --check          # Dry-run: show pending
    python scripts/data/migrate/migrate_tenants.py --create-all     # create_all() fallback
