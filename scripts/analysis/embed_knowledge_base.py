...
Usage:
    python scripts/analysis/embed_knowledge_base.py                  # Index all entities
    python scripts/analysis/embed_knowledge_base.py --entity-types requirement,risk
    python scripts/analysis/embed_knowledge_base.py --program-id 1   # Filter by program
    python scripts/analysis/embed_knowledge_base.py --clear           # Clear embeddings first
"""
