...
| Migration | `scripts/data/migrate/migrate_tenants.py` | Alembic migration + schema verification (85 tablo) |
...
> **Kaynak:** docs/archive/SAP_Platform_Project_Plan_v2.2.md
...
**Dosya:** `sap_transformation_platform_architecture_v1_backup.md`
