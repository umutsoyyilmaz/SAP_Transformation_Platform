...
# 4. Doğrula
python scripts/data/migrate/migrate_tenants.py --verify
```
...
python scripts/data/seed/seed_quick_demo.py --scenario otc

# Sadece PTP senaryosu
python scripts/data/seed/seed_quick_demo.py --scenario ptp

# Mevcut veriyi silmeden ek veri ekle
python scripts/data/seed/seed_quick_demo.py --no-reset
```
...
docker compose -f docker/docker-compose.yml exec app python scripts/data/seed/seed_quick_demo.py
