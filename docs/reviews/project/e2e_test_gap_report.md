...
**Test Script:** `scripts/testing/e2e_local_test.py`
**Test Plan:** `docs/plans/SAP_ACTIVATE_E2E_TEST_PLAN.md`
...
The test plan document (`docs/plans/SAP_ACTIVATE_E2E_TEST_PLAN.md`) uses a different vocabulary than the actual platform API. These are **NOT platform bugs** but documentation/test plan mismatches:
...
1. **Test plan documentation update** — The `docs/plans/SAP_ACTIVATE_E2E_TEST_PLAN.md` uses outdated field names and endpoints. Update to match actual API vocabulary (see Section 3).
