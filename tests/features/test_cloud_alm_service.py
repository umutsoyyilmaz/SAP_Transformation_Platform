...
class TestPushRequirements:
    ...
    def test_push_requirements_calls_push_gateway_method(self):
        ...
        _make_config(tenant_id=t.id)
        _make_requirement(program_id=prog.id, tenant_id=t.id, code_suffix="001")
        db.session.commit()
    ...
    def test_push_requirements_writes_sync_log_on_success(self):
        ...
        prog = _make_program(tenant_id=t.id)
        _make_config(tenant_id=t.id)
        _make_requirement(program_id=prog.id, tenant_id=t.id, code_suffix="002")
        db.session.commit()
    ...
    def test_push_requirements_writes_sync_log_on_error(self):
        ...
        prog = _make_program(tenant_id=t.id)
        _make_config(tenant_id=t.id)
        _make_requirement(program_id=prog.id, tenant_id=t.id, code_suffix="003")
        db.session.commit()
    ...
    def test_push_requirements_updates_external_id_on_each_requirement(self):
        ...
        prog = _make_program(tenant_id=t.id)
        _make_config(tenant_id=t.id)
        req = _make_requirement(program_id=prog.id, tenant_id=t.id, code_suffix="004")
        db.session.commit()
