"""Sprint 7.3: make core Project Setup entities require project_id.
...
This migration intentionally fails fast if any NULL project_id rows remain.
Backfill must be completed before applying it.
"""
...
revision = "6f7g8h9i0j107"
down_revision = "5e6f7g8h9i06"
branch_labels = None
depends_on = None
